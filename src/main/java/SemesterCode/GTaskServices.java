...
public class GTaskServices {
    private static final String APPLICATION_NAME = "Semester Planning Tool";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GTaskServices.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    private static Tasks getAPIClientService() throws IOException, GeneralSecurityException{
    ...
    //this main method from Google- Java Google Tasks Quickstart code
